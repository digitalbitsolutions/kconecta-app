...
type RoleMismatchRoute = RouteProp<ManagerStackParamList, "RoleMismatch">;
type RoleMismatchNavigation = NativeStackNavigationProp<ManagerStackParamList, "RoleMismatch">;
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.body}>
          Current role cannot continue this flow. Re-authenticate with a valid role to proceed.
        </Text>
