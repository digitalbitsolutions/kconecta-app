...
- [ ] OpenClaw fallback sigue en observacion.
  - Estado: fallback se activa, pero esta variante puede intentar editar fuera de `files_scope`.
  - Mitigacion: mantener `AI_EXECUTOR=aider` por defecto en ejecucion real.
- [ ] Aider puede tardar en tareas largas.
  - Mitigacion ya aplicada: prompt corto, particion por scope, timeouts/retries por agente, timeout-recovery.
